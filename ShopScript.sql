...
GO
INSERT [dbo].[Product] ([ProductId], [ArticleNumber], [Name], [Description], [Category], [Photo], [Manufacturer], [Cost], [DiscountAmount], [QuantityInStock], [Status]) VALUES (1, N'A436H7', N'Хайлайтер Сияние Звезд', N'Иллюминатор с мерцающими частицами для создания эффекта сияющей кожи.', N'Косметика', N'1', N'Becca Cosmetics', CAST(2399.0000 AS Decimal(19, 4)), 65, 16, N'В наличии')
GO
INSERT [dbo].[Product] ([ProductId], [ArticleNumber], [Name], [Description], [Category], [Photo], [Manufacturer], [Cost], [DiscountAmount], [QuantityInStock], [Status]) VALUES (2, N'D344Y7', N'Тени Вечерний Гламур', N'Палетка теней для век с 16 оттенками, включая матовые и металлические.', N'Косметика', N'1', N'Too Faced', CAST(31999.0000 AS Decimal(19, 4)), 14, 47, N'В наличии')
GO
INSERT [dbo].[Product] ([ProductId], [ArticleNumber], [Name], [Description], [Category], [Photo], [Manufacturer], [Cost], [DiscountAmount], [QuantityInStock], [Status]) VALUES (3, N'D378D3', N'Помада Нежный Блеск', N'Блеск для губ с увлажняющим эффектом и легким ароматом манго.', N'Косметика', N'1', N'Buxom', CAST(12799.0000 AS Decimal(19, 4)), 19, 266, N'В наличии')
GO
INSERT [dbo].[Product] ([ProductId], [ArticleNumber], [Name], [Description], [Category], [Photo], [Manufacturer], [Cost], [DiscountAmount], [QuantityInStock], [Status]) VALUES (4, N'D526R4', N'Чистая Энергия', N'Энергетический тоник для лица с экстрактом зеленого чая и витамином C.', N'Косметика', N'1', N'Kiehls', CAST(1499.0000 AS Decimal(19, 4)), 46, 84, N'В наличии')
GO
INSERT [dbo].[Product] ([ProductId], [ArticleNumber], [Name], [Description], [Category], [Photo], [Manufacturer], [Cost], [DiscountAmount], [QuantityInStock], [Status]) VALUES (5, N'E245R5', N'Парфюм Романтический Вечер', N'Духи с романтическим ароматом, сочетающим ноты розы, ванили и мускуса.', N'Парфюмерия', N'1', N'Yves Saint Laurent', CAST(16099.0000 AS Decimal(19, 4)), 19, 100, N'В наличии')
GO
INSERT [dbo].[Product] ([ProductId], [ArticleNumber], [Name], [Description], [Category], [Photo], [Manufacturer], [Cost], [DiscountAmount], [QuantityInStock], [Status]) VALUES (6, N'E479G6', N'Тушь Сияющие Ресницы', N'Тушь для ресниц с эффектом удлинения и объема, водостойкая.', N'Косметика', N'1', N'Benefit Cosmetics', CAST(1099.0000 AS Decimal(19, 4)), 0, 0, N'Нет в наличии')
GO
INSERT [dbo].[Product] ([ProductId], [ArticleNumber], [Name], [Description], [Category], [Photo], [Manufacturer], [Cost], [DiscountAmount], [QuantityInStock], [Status]) VALUES (7, N'E530Y6', N'Румяна Свежий Цвет Лица', N'Кремовые румяна для создания естественного румянца.', N'Косметика', N'1', N'Bobbi Brown', CAST(4899.0000 AS Decimal(19, 4)), 5, 20, N'В наличии')
GO
INSERT [dbo].[Product] ([ProductId], [ArticleNumber], [Name], [Description], [Category], [Photo], [Manufacturer], [Cost], [DiscountAmount], [QuantityInStock], [Status]) VALUES (8, N'E573G6', N'Пудра Идеальная Кожа', N'Пудра для лица с матирующим эффектом и легким покрытием.', N'Косметика', N'1', N'Laura Mercier', CAST(41999.0000 AS Decimal(19, 4)), 30, 41, N'В наличии')
GO
INSERT [dbo].[Product] ([ProductId], [ArticleNumber], [Name], [Description], [Category], [Photo], [Manufacturer], [Cost], [DiscountAmount], [QuantityInStock], [Status]) VALUES (9, N'F344S4', N'Чистая Свежесть', N'Тоник для лица', N'Косметика', N'1', N'Lancôme', CAST(9999.0000 AS Decimal(19, 4)), 30, 18, N'В наличии')
GO
INSERT [dbo].[Product] ([ProductId], [ArticleNumber], [Name], [Description], [Category], [Photo], [Manufacturer], [Cost], [DiscountAmount], [QuantityInStock], [Status]) VALUES (10, N'F346G5', N'Бальзам для губ Сияющие Губы', N'Губная косметика', N'Косметика', N'1', N'La Roche-Posay', CAST(1499.0000 AS Decimal(19, 4)), 111, 200, N'В наличии')
GO
INSERT [dbo].[Product] ([ProductId], [ArticleNumber], [Name], [Description], [Category], [Photo], [Manufacturer], [Cost], [DiscountAmount], [QuantityInStock], [Status]) VALUES (11, N'F893T5', N'Парфюм Элегантный Аромат', N'Духи с элегантным и изысканным ароматом, сочетающим ноты жасмина, розы и сандалового дерева.', N'Парфюмерия', N'1', N'Chloé', CAST(6499.0000 AS Decimal(19, 4)), 7, 19, N'В наличии')
GO
INSERT [dbo].[Product] ([ProductId], [ArticleNumber], [Name], [Description], [Category], [Photo], [Manufacturer], [Cost], [DiscountAmount], [QuantityInStock], [Status]) VALUES (12, N'G532R5', N'Парфюм Том Форд', N'Объёмный запах', N'Парфюмерия', N'1', N'ДольчеМилк', CAST(47199.0000 AS Decimal(19, 4)), 42, 56, N'В наличии')
GO
INSERT [dbo].[Product] ([ProductId], [ArticleNumber], [Name], [Description], [Category], [Photo], [Manufacturer], [Cost], [DiscountAmount], [QuantityInStock], [Status]) VALUES (13, N'H732R5', N'Блеск для губ Бьюти Блос', N'Ультраглянц', N'Косметика', N'1', N'ФентиБьюти', CAST(32199.0000 AS Decimal(19, 4)), 7, 410, N'В наличии')
GO
INSERT [dbo].[Product] ([ProductId], [ArticleNumber], [Name], [Description], [Category], [Photo], [Manufacturer], [Cost], [DiscountAmount], [QuantityInStock], [Status]) VALUES (14, N'J432E4', N'Парфюм какой-то евес Сейнт', N'Соблазнительный', N'Парфюмерия', N'1', N'ОБС студио', CAST(4899.0000 AS Decimal(19, 4)), 7, 150, N'В наличии')
GO
INSERT [dbo].[Product] ([ProductId], [ArticleNumber], [Name], [Description], [Category], [Photo], [Manufacturer], [Cost], [DiscountAmount], [QuantityInStock], [Status]) VALUES (15, N'K535G6', N'Парфюм Ламком', N'Ноты ириса', N'Парфюмерия', N'1', N'Нарс', CAST(65099.0000 AS Decimal(19, 4)), 69, 88, N'В наличии')
GO
INSERT [dbo].[Product] ([ProductId], [ArticleNumber], [Name], [Description], [Category], [Photo], [Manufacturer], [Cost], [DiscountAmount], [QuantityInStock], [Status]) VALUES (16, N'O875F6', N'Помада А4', N'Высокое покрытие', N'Косметика', N'1', N'Влад Бумага', CAST(2799.0000 AS Decimal(19, 4)), 57, 78, N'В наличии')
GO
INSERT [dbo].[Product] ([ProductId], [ArticleNumber], [Name], [Description], [Category], [Photo], [Manufacturer], [Cost], [DiscountAmount], [QuantityInStock], [Status]) VALUES (17, N'R464G6', N'Консиллер Нарс', N'Идеальный макияж', N'Косметика', N'1', N'ДольчеМилк', CAST(12599.0000 AS Decimal(19, 4)), 18, 15, N'В наличии')
GO
INSERT [dbo].[Product] ([ProductId], [ArticleNumber], [Name], [Description], [Category], [Photo], [Manufacturer], [Cost], [DiscountAmount], [QuantityInStock], [Status]) VALUES (18, N'S753T5', N'Бронзер Рандомный Эффект', N'Матовый', N'Косметика', N'1', N'Студия Рандом', CAST(1099.0000 AS Decimal(19, 4)), 90, 183, N'В наличии')
GO
INSERT [dbo].[Product] ([ProductId], [ArticleNumber], [Name], [Description], [Category], [Photo], [Manufacturer], [Cost], [DiscountAmount], [QuantityInStock], [Status]) VALUES (19, N'V472S3', N'Крем ТартеШапе', N'От загара и перегара', N'Косметика', N'1', N'ТомФорд', CAST(1999.0000 AS Decimal(19, 4)), 48, 75, N'В наличии')
GO
INSERT [dbo].[Product] ([ProductId], [ArticleNumber], [Name], [Description], [Category], [Photo], [Manufacturer], [Cost], [DiscountAmount], [QuantityInStock], [Status]) VALUES (20, N'А112Т4', N'Парфюм Шанель', N'Легендарный женский', N'Парфюмерия', N'1', N'Кокошанель', CAST(1299.0000 AS Decimal(19, 4)), 2, 10, N'В наличии')
GO
